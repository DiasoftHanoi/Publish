...
template.attachObj = (function(gridId){
        ...
        //тут нужно начитать id старого документа в fileSystem и в есм
             form.dsCall('[frontws2]', 'attachmentGetListByParams', {
                  ...
                  ORDERBY: "CREATIONDATE DESC",
                   ...
                   if (resp.data.TOTALCOUNT != 0){ console.log("старый отчет найден");
                        ...
                        form.dsCall('[frontws2]', 'attachmentModify', {
                               ...
                               if (resp.data.Status === 'OK'){ console.log("обновление успешно"); console.log("subject3 = " + subject); console.log("attachmentType3 = " + attachmentType);
                                    options.updateECM(subject, attachmentType, ecmFileID);
    ...
    options.updateECM = function (subject, attachmentType, ecmFileID) { console.log("update_ECM"); console.log("subject = " + subject); console.log("ecmFileID = " + ecmFileID);
        var uploadFile = options.uploadFile;
