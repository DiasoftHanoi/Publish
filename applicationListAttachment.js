        ...
        //тут нужно начитать id старого документа
             form.dsCall('[frontws2]', 'attachmentGetListByParams', {
                  ...
                  ORDERBY: "CREATIONDATE DESC",
                   ...
                   if (resp.data.TOTALCOUNT != 0){ console.log("старый отчет найден"); console.log("subject = " + subject); console.log("options.subject = " + options.subject);
                        var uploadFileID = resp.data.Result[0].ATTACHMENTID;
                        ...
                        form.dsCall('[frontws2]', 'attachmentModify', {
                               ...
                               if (resp.data.Status === 'OK'){ console.log("обновление успешно"); console.log("subject3 = " + subject);
                                    options.updateECM(subject, attachmentType);
                                    //template.parentForm.action("REFRESH");
                               }
                        }).catch(function (e) {
